...
if ($hassiteconfig) {
    ...
    // Face recognition method choice. The 'BS' value is kept for backward
    // compatibility with stored configuration; it selects the AI face match service.
    $choices = [
        'BS' => 'AI face match',
        'None' => 'None',
    ];
    ...
    // Face match service API settings.
    ...
    // Diagnostic logging for face match attempts.
    $settings->add(new admin_setting_configcheckbox('quizaccess_proctoring/debuglog',
        get_string('setting:debuglog', 'quizaccess_proctoring'),
        get_string('setting:debuglogdesc', 'quizaccess_proctoring'), '0'));
